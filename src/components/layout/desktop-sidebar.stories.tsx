...
const description = 'Desktop navigation sidebar with active state and icons.'

const sections: DocSectionConfig[] = [
  {
    title: 'Default',
    description: 'Sidebar with interactive navigation items.',
    width: 'layout',
    code: `import { DesktopSidebar } from '@/components/layout/desktop-sidebar'
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      ...
      page: createComponentDocPage(DesktopSidebar, description, sections),
    },
  },
