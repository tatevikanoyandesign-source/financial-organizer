...
import { AiChatPrompt } from './ai-chat-prompt'

const description =
  'Home tab AI assistant card with quick-suggestion chips and a free-text prompt input.'

const sections: DocSectionConfig[] = [
  {
    title: 'Default',
    description:
      'Heading, four suggestion chips, and an input for open-ended financial questions.',
    width: 'mobile',
    code: `import { AiChatPrompt } from '@/components/financial/ai-chat-prompt'
...
const meta = {
  title: 'Financial/AiChatPrompt',
  component: AiChatPrompt,
  tags: ['autodocs'],
  parameters: {
    layout: 'fullscreen',
    docs: {
      description: { component: description },
      page: createComponentDocPage(AiChatPrompt, description, sections),
    },
  },
} satisfies Meta<typeof AiChatPrompt>
