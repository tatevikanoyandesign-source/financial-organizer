...
const description = 'Toggle between light and dark color themes.'

const sections: DocSectionConfig[] = [
  {
    title: 'Light',
    description: 'Theme toggle shown in light mode.',
    width: 'form',
    code: `import { ThemeToggle } from '@/components/theme/theme-toggle'
...
export function LightExample() {
  ...
  {
    title: 'Dark',
    description: 'Theme toggle shown in dark mode.',
    width: 'form',
    code: `import { ThemeToggle } from '@/components/theme/theme-toggle'

export function DarkExample() {
  return <ThemeToggle theme="dark" onToggle={() => {}} />
}`,
    render: () => (
      <DarkPreview>
        <ThemeToggle theme="dark" onToggle={fn()} />
      </DarkPreview>
    ),
  },
]
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      ...
      page: createComponentDocPage(ThemeToggle, description, sections),
    },
  },
