...
const description = 'Vault tab with entity filters and a scrollable document list.'

const sections: DocSectionConfig[] = [
  {
    title: 'Mobile',
    description: '390px mobile shell showing the full Vault document list.',
    width: 'mobile',
    code: `import { VaultTabPage } from '@/pages/vault-tab-page'

export function VaultTabMobileExample() {
  return <VaultTabPage variant="mobile" />
}`,
    render: () => <VaultTabPage variant="mobile" />,
  },
]

const meta = {
  title: 'Pages/Mobile/VaultTab',
