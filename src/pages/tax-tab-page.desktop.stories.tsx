...
const description =
  'Desktop Tax tab with filing checklist and strategy placeholder at full width.'

const sections: DocSectionConfig[] = [
  {
    title: 'Desktop',
    description: 'Full-width Tax tab with gap-6 spacing between sections.',
    width: 'full',
    code: `import { TaxTabPage } from '@/pages/tax-tab-page'

export function TaxTabDesktopExample() {
  return <TaxTabPage variant="desktop" />
}`,
    render: () => <TaxTabPage variant="desktop" />,
  },
]

const meta = {
  title: 'Pages/Desktop/TaxTab',
