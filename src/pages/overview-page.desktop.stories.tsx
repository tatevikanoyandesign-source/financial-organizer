...
const description =
  'Dashboard overview with summary, accounts, transactions, and insights.'
const sections = buildPageSections(OverviewPage, 'desktop', '@/pages/overview-page')

const meta = {
  title: 'Pages/Desktop/Overview',
  component: OverviewPage,
  parameters: buildPageDocs(OverviewPage, description, sections),
