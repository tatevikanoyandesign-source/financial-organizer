...
const description = 'Financial insights and recommendations.'
const sections = buildPageSections(InsightsPage, 'desktop', '@/pages/insights-page')

const meta = {
  title: 'Pages/Desktop/Insights',
  component: InsightsPage,
  parameters: buildPageDocs(InsightsPage, description, sections),
