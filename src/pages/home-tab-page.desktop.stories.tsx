...
const description =
  'Desktop Home tab with gap-6 spacing between composed financial sections.'

const sections: DocSectionConfig[] = [
  {
    title: 'Desktop',
    description: 'Full-width Home tab layout with wider section spacing.',
    width: 'full',
    code: `import { HomeTabPage } from '@/pages/home-tab-page'

export function HomeTabDesktopExample() {
  return <HomeTabPage variant="desktop" />
}`,
    render: () => <HomeTabPage variant="desktop" />,
  },
]

const meta = {
  title: 'Pages/Desktop/HomeTab',
