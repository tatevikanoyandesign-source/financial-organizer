...
import { TaxTabPage } from './tax-tab-page'
...
const description =
  'Tax tab with filing readiness checklist and a placeholder strategy section.'

const sections: DocSectionConfig[] = [
  {
    title: 'Mobile',
    description: '390px mobile shell with tax checklist and strategy placeholder.',
    width: 'mobile',
    code: `import { TaxTabPage } from '@/pages/tax-tab-page'

export function TaxTabMobileExample() {
  return <TaxTabPage variant="mobile" />
}`,
    render: () => <TaxTabPage variant="mobile" />,
  },
]

const meta = {
  title: 'Pages/Mobile/TaxTab',
  component: TaxTabPage,
  tags: ['autodocs'],
  parameters: {
    layout: 'fullscreen',
    docs: {
      description: { component: description },
      page: createComponentDocPage(TaxTabPage, description, sections),
    },
  },
} satisfies Meta<typeof TaxTabPage>
