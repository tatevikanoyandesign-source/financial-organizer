...
const description = 'Linked accounts list with balances and institution details.'
const sections = buildPageSections(AccountsPage, 'desktop', '@/pages/accounts-page')

const meta = {
  title: 'Pages/Desktop/Accounts',
  component: AccountsPage,
  parameters: buildPageDocs(AccountsPage, description, sections),
