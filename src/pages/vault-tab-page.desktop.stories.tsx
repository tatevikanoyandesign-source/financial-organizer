...
import { VaultTabPage } from './vault-tab-page'
...
const description = 'Desktop Vault tab with full-width document list layout.'

const sections: DocSectionConfig[] = [
  {
    title: 'Desktop',
    description: 'Full-width Vault tab with entity filters and document cards.',
    width: 'full',
    code: `import { VaultTabPage } from '@/pages/vault-tab-page'

export function VaultTabDesktopExample() {
  return <VaultTabPage variant="desktop" />
}`,
    render: () => <VaultTabPage variant="desktop" />,
  },
]

const meta = {
  title: 'Pages/Desktop/VaultTab',
  component: VaultTabPage,
  tags: ['autodocs'],
  parameters: {
    layout: 'fullscreen',
    docs: {
      description: { component: description },
      page: createComponentDocPage(VaultTabPage, description, sections),
    },
  },
} satisfies Meta<typeof VaultTabPage>
