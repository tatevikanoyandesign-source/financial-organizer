...
const description =
  'Home tab composed from entity switcher, AI prompt, accounts, budget snapshot, and activity feed.'

const sections: DocSectionConfig[] = [
  {
    title: 'Mobile',
    description:
      '390px mobile shell with gap-4 spacing between Home tab sections.',
    width: 'mobile',
    code: `import { HomeTabPage } from '@/pages/home-tab-page'

export function HomeTabMobileExample() {
  return <HomeTabPage variant="mobile" />
}`,
    render: () => <HomeTabPage variant="mobile" />,
  },
]

const meta = {
  title: 'Pages/Mobile/HomeTab',
  ...
  parameters: {
    ...
    docs: {
      ...
      page: createComponentDocPage(HomeTabPage, description, sections),
    },
  },
} satisfies Meta<typeof HomeTabPage>
