...
const description = 'Budget categories with spending progress.'
const sections = buildPageSections(BudgetsPage, 'desktop', '@/pages/budgets-page')

const meta = {
  title: 'Pages/Desktop/Budgets',
  component: BudgetsPage,
  parameters: buildPageDocs(BudgetsPage, description, sections),
