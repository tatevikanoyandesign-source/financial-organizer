...
const description = 'App preferences and connected accounts.'
const sections = buildPageSections(SettingsPage, 'desktop', '@/pages/settings-page')

const meta = {
  title: 'Pages/Desktop/Settings',
  component: SettingsPage,
  parameters: buildPageDocs(SettingsPage, description, sections),
